    ...
    public void runSimulator() {
        ...
        while (true) {
            ...
            if (nextEvent == null) {
                ...
                System.out.println(Arrays.toString(n0.lkcost));
                System.out.println(Arrays.toString(n1.lkcost));
                System.out.println(Arrays.toString(n2.lkcost));
                System.out.println(Arrays.toString(n3.lkcost));
                break;
            }
        ...
        System.out.println(msgSent + " messages sent");
